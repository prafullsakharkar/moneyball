...
from repository_brain.api.routes import context as context_route
...
from repository_brain.api.routes import knowledge as knowledge_route
...
from repository_brain.api.routes import repository_index as repository_index_route
...
api_router.include_router(repository_index_route.router)
api_router.include_router(context_route.router)
...
api_router.include_router(knowledge_route.router)
