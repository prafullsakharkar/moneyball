...
- Name: 404-detection.spec.ts >> 404 Page Detection Tests >> Navigation Paths - Should All Load Successfully >> should load /matches/commentary without 404
...
- generic [ref=e3]:
  ...
  - main [ref=e228]:
    - generic [ref=e231]:
      - heading "Commentary" [level=2] [ref=e232]
      - paragraph [ref=e233]: Live match commentary.
```
