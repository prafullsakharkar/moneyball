...
- Name: 404-detection.spec.ts >> 404 Page Detection Tests >> Navigation Paths - Should All Load Successfully >> should load /teams/analytics without 404
...
Call log:
  - navigating to "http://localhost:5173/teams/analytics", waiting until "load"
  ...
  - complementary [ref=e4]:
    ...
    - navigation [ref=e14]:
      ...
      - generic [ref=e34]:
        ...
        - generic [ref=e45]:
          - button "All Teams" [ref=e46]
          - button "Team Analytics" [ref=e53]
      - button "Players" [ref=e58]
      - button "Matches 12" [ref=e66]:
        - generic [ref=e69]: Matches
        - generic [ref=e70]: "12"
      - generic [ref=e73]:
        - button "Analytics" [ref=e74]
        - generic [ref=e81]:
          - button "Team" [ref=e82]
          - button "Player" [ref=e89]
          - button "Match" [ref=e94]
          - button "Tournament" [ref=e98]
          - button "AI" [ref=e106]
      - button "Video Analysis" [ref=e117]
      - button "Academy" [ref=e125]
      - button "Training" [ref=e133]
      - button "Auction" [ref=e144]
      - button "Fantasy" [ref=e155]
      - button "Notifications" [ref=e161]
      - button "Sponsorship" [ref=e166]
      - button "Monetization" [ref=e170]
      - button "Reports" [ref=e174]
      - button "Administration" [ref=e181]
      - button "More" [ref=e199]
    - generic [ref=e207]:
      - generic [ref=e208]: A
      - generic [ref=e209]:
        - paragraph [ref=e210]: Admin User
        - paragraph [ref=e211]: v1.0.0
  - banner [ref=e212]:
    - button "Search players, teams... ⌘K" [ref=e213]:
      - generic [ref=e217]: Search players, teams...
      - generic [ref=e218]: ⌘K
    - generic [ref=e219]:
      - button [ref=e220]
      - button "AI Assistant" [ref=e223]
      - button [ref=e226]
      - generic [ref=e231]: A
  - main [ref=e232]:
    - generic [ref=e236]:
      - generic [ref=e237]:
        - heading "Teams" [level=1] [ref=e238]
        - paragraph [ref=e239]: Explore all teams and performance metrics
      - textbox "Search teams..." [ref=e244]
```
