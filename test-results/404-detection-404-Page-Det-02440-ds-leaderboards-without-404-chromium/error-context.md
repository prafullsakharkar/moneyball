...
- Name: 404-detection.spec.ts >> 404 Page Detection Tests >> Navigation Paths - Should All Load Successfully >> should load /analytics/awards/leaderboards without 404
...
Call log:
  - navigating to "http://localhost:5173/analytics/awards/leaderboards", waiting until "load"
