...
- Name: 404-detection.spec.ts >> 404 Page Detection Tests >> Navigation Paths - Should All Load Successfully >> should load /training/sessions without 404
...
Call log:
  - navigating to "http://localhost:5173/training/sessions", waiting until "load"
