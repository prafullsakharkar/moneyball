...
- Name: 404-detection.spec.ts >> 404 Page Detection Tests >> Navigation Paths - Should All Load Successfully >> should load /dashboard/players without 404
...
- generic [ref=e3]:
  ...
  - main [ref=e183]:
    - generic [ref=e186]:
      - generic [ref=e187]:
        - generic [ref=e188]:
          - heading "Players" [level=1] [ref=e189]
          - paragraph [ref=e190]: Explore player profiles and performance
        - textbox "Search players..." [ref=e196]
      - generic [ref=e197]:
        - button "All" [ref=e198]
        - button "Batsman" [ref=e199]
        - button "Bowler" [ref=e200]
        - button "All rounder" [ref=e201]
        - button "Wicket keeper" [ref=e202]
```
